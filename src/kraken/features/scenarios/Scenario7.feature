...
Scenario: Create a post with multiple tags - Scenario 7
  ...
  And I wait
  Then I navigate to page "http://localhost:2370/ghost/#/posts?tag=tag1"
  And I wait
  And the post should be updated with the tag slug "tag1" - Scenario seven
  And I navigate to page "http://localhost:2370/ghost/#/posts?tag=tag2"
  And I wait
  And the post should be updated with the tag slug "tag2" - Scenario seven
  And I navigate to page "http://localhost:2370/ghost/#/posts?tag=tag3"
  And I wait
