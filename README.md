...
- La documentación más a fondo de los escenarios de prueba de generación de datos se encuentra en la wiki del repositorio.
...
Debido a que con cada ejecución diferente del workflow se genera un reporte diferente, se decidió usar un reporte estático para el video. Este reporte se puede encontrar en la siguiente URL: https://code-automators.github.io/ghost-e2e/ExampleReport/
